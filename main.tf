...
resource "aws_security_group" "app_sg" {
  ...
  ingress {
    ...
    description     = "Permitir tráfico solo desde el ALB"
  }
...
resource "aws_security_group" "rds_sg" {
  ...
  ingress {
    ...
    description     = "Permitir tráfico solo desde la capa de aplicación"
  }
...
resource "aws_launch_template" "app_lt" {
  name_prefix   = "app-lt-"
  image_id      = "ami-053b0d53c27927902" # Amazon Linux 2023 (Ejemplo)
  instance_type = "t3.micro" # Free Tier
  key_name      = "tu_clave_ssh" # Reemplazar con el nombre de tu clave SSH
